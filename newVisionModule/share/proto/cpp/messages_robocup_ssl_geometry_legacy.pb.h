...
class SSL_GeometryFieldSize :
 ...
 public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    ...
    return ::descriptor_table_messages_5frobocup_5fssl_5fgeometry_5flegacy_2eproto.file_level_metadata[kIndexInFileMessages];
  }
...
inline ::RoboCup2014Legacy::Geometry::SSL_GeometryFieldSize* SSL_GeometryData::_internal_mutable_field() {
  _has_bits_[0] |= 0x00000001u;
  if (field_ == nullptr) {
    auto* p = CreateMaybeMessage<::RoboCup2014Legacy::Geometry::SSL_GeometryFieldSize>(GetArenaNoVirtual());
    field_ = p;
  }
  return field_;
}
