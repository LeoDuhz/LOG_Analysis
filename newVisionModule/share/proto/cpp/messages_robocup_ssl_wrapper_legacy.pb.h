...
::PROTOBUF_NAMESPACE_ID::Metadata descriptor_table_messages_5frobocup_5fssl_5fwrapper_5flegacy_2eproto_metadata_getter(int index);
...
class SSL_WrapperPacket PROTOBUF_FINAL :
 ...
 public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    return ::descriptor_table_messages_5frobocup_5fssl_5fwrapper_5flegacy_2eproto_metadata_getter(kIndexInFileMessages);
  }
  ...
  void unsafe_arena_set_allocated_geometry(
      ::RoboCup2014Legacy::Geometry::SSL_GeometryData* geometry);
  ::RoboCup2014Legacy::Geometry::SSL_GeometryData* unsafe_arena_release_geometry();
...
inline ::RoboCup2014Legacy::Geometry::SSL_GeometryData* SSL_WrapperPacket::unsafe_arena_release_geometry() {
...
inline ::RoboCup2014Legacy::Geometry::SSL_GeometryData* SSL_WrapperPacket::_internal_mutable_geometry() {
  ...
  if (geometry_ == nullptr) {
    auto* p = CreateMaybeMessage<::RoboCup2014Legacy::Geometry::SSL_GeometryData>(GetArena());
    geometry_ = p;
  }
  return geometry_;
}
