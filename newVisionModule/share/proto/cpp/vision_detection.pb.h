...
::PROTOBUF_NAMESPACE_ID::Metadata descriptor_table_vision_5fdetection_2eproto_metadata_getter(int index);
...
class Vision_DetectionBall PROTOBUF_FINAL :
 ...
 public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    return ::descriptor_table_vision_5fdetection_2eproto_metadata_getter(kIndexInFileMessages);
  }
...
class Vision_DetectionRobot PROTOBUF_FINAL :
...
class Vision_DetectionFrame PROTOBUF_FINAL :
...
inline ::Vision_DetectionBall* Vision_DetectionFrame::_internal_mutable_balls() {
  _has_bits_[0] |= 0x00000001u;
  if (balls_ == nullptr) {
    auto* p = CreateMaybeMessage<::Vision_DetectionBall>(GetArena());
    balls_ = p;
  }
  return balls_;
}
