...
::PROTOBUF_NAMESPACE_ID::Metadata descriptor_table_messages_5frobocup_5fssl_5fwrapper_2eproto_metadata_getter(int index);
...
class SSL_WrapperPacket PROTOBUF_FINAL :
 ...
 public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    return ::descriptor_table_messages_5frobocup_5fssl_5fwrapper_2eproto_metadata_getter(kIndexInFileMessages);
  }
