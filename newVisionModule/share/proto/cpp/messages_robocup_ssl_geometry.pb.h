...
::PROTOBUF_NAMESPACE_ID::Metadata descriptor_table_messages_5frobocup_5fssl_5fgeometry_2eproto_metadata_getter(int index);
...
class Vector2f PROTOBUF_FINAL :
 ...
 public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    return ::descriptor_table_messages_5frobocup_5fssl_5fgeometry_2eproto_metadata_getter(kIndexInFileMessages);
  }
...
class SSL_FieldLineSegment PROTOBUF_FINAL :
 ...
 public:
  ...
  explicit constexpr SSL_FieldLineSegment(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
...
class SSL_FieldCicularArc PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:SSL_FieldCicularArc) */ {
 public:
  inline SSL_FieldCicularArc() : SSL_FieldCicularArc(nullptr) {}
  virtual ~SSL_FieldCicularArc();
  explicit constexpr SSL_FieldCicularArc(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  void UnsafeArenaSwap(SSL_FieldCicularArc* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetArena() == other->GetArena());
    InternalSwap(other);
  }
  ...
  protected:
  explicit SSL_FieldCicularArc(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  private:
  static void ArenaDtor(void* object);
  inline void RegisterArenaDtor(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  public:
...
class SSL_GeometryCameraCalibration PROTOBUF_FINAL :
 ...
 public:
  ...
  explicit constexpr SSL_GeometryCameraCalibration(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
...
inline void SSL_FieldCicularArc::unsafe_arena_set_allocated_center(
    ::Vector2f* center) {
  if (GetArena() == nullptr) {
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:SSL_FieldCicularArc.center)
}
...
inline ::Vector2f* SSL_FieldCicularArc::unsafe_arena_release_center() {
