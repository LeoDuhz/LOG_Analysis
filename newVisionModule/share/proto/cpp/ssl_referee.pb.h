...
class Referee :
 ...
 public:
  ...
  PROTOBUF_DEPRECATED static constexpr Command GOAL_YELLOW =
    Referee_Command_GOAL_YELLOW;
  PROTOBUF_DEPRECATED static constexpr Command GOAL_BLUE =
...
inline void ProposedGameEvent::clear_proposer_id() {
  proposer_id_.ClearToEmptyNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
  _has_bits_[0] &= ~0x00000001u;
}
...
inline void ProposedGameEvent::_internal_set_proposer_id(const std::string& value) {
  _has_bits_[0] |= 0x00000001u;
  proposer_id_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), value);
}
...
inline void ProposedGameEvent::set_proposer_id(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  _has_bits_[0] |= 0x00000001u;
  proposer_id_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
...
inline void ProposedGameEvent::set_proposer_id(const char* value, size_t size) {
  _has_bits_[0] |= 0x00000001u;
  proposer_id_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
...
inline std::string* ProposedGameEvent::_internal_mutable_proposer_id() {
  _has_bits_[0] |= 0x00000001u;
  return proposer_id_.MutableNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline std::string* ProposedGameEvent::release_proposer_id() {
  ...
  _has_bits_[0] &= ~0x00000001u;
  return proposer_id_.ReleaseNonDefaultNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline void ProposedGameEvent::set_allocated_proposer_id(std::string* proposer_id) {
  ...
  proposer_id_.SetAllocatedNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), proposer_id);
