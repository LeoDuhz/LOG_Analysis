...
class LabelerMetadata :
 ...
 public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    ...
    return ::descriptor_table_log_5flabeler_5fdata_2eproto.file_level_metadata[kIndexInFileMessages];
  }
...
inline ::SSL_WrapperPacket* LabelerFrame::_internal_mutable_vision_frame() {
  if (!_internal_has_vision_frame()) {
    ...
    frame_.vision_frame_ = CreateMaybeMessage< ::SSL_WrapperPacket >(
        GetArenaNoVirtual());
  }
...
inline ::Referee* LabelerFrame::_internal_mutable_referee_frame() {
  if (!_internal_has_referee_frame()) {
    ...
    frame_.referee_frame_ = CreateMaybeMessage< ::Referee >(
        GetArenaNoVirtual());
  }
