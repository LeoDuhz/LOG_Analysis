...
class RecMessages PROTOBUF_FINAL :
 ...
 public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    ...
    return ::descriptor_table_zss_5frec_2eproto.file_level_metadata[kIndexInFileMessages];
  }
...
inline ::ZSS::Protocol::SelectedArea* RecMessage::release_selectedarea() {
  auto temp = unsafe_arena_release_selectedarea();
  if (GetArena() != nullptr) {
...
inline ::ZSS::Protocol::MaintainVision* RecMessage::release_maintainvision() {
  auto temp = unsafe_arena_release_maintainvision();
  if (GetArena() != nullptr) {
    temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
  }
  return temp;
...
inline ::ZSS::Protocol::Debug_Msgs* RecMessage::release_athenadebugmsgs() {
  auto temp = unsafe_arena_release_athenadebugmsgs();
  if (GetArena() != nullptr) {
    temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
  }
  return temp;
...
inline ::ZSS::Protocol::Balls4Rec* MaintainVision::release_balls() {
  auto temp = unsafe_arena_release_balls();
  if (GetArena() != nullptr) {
    temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
  }
  return temp;
