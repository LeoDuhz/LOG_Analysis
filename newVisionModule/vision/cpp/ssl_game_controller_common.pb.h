...
class Signature PROTOBUF_FINAL :
 ...
 public:
  ...
  "    string fields are deprecated and will be removed in a"
  "    future release.")
  std::string* unsafe_arena_release_pkcs1v15();
  GOOGLE_PROTOBUF_RUNTIME_DEPRECATED("The unsafe_arena_ accessors for"
  "    string fields are deprecated and will be removed in a"
  "    future release.")
  void unsafe_arena_set_allocated_pkcs1v15(
      std::string* pkcs1v15);
  private:
...
inline std::string* ControllerReply::unsafe_arena_release_reason() {
  // @@protoc_insertion_point(field_unsafe_arena_release:ControllerReply.reason)
  GOOGLE_DCHECK(GetArena() != nullptr);
  _has_bits_[0] &= ~0x00000001u;
  return reason_.UnsafeArenaRelease(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      GetArena());
}
inline void ControllerReply::unsafe_arena_set_allocated_reason(
    std::string* reason) {
  GOOGLE_DCHECK(GetArena() != nullptr);
  if (reason != nullptr) {
    _has_bits_[0] |= 0x00000001u;
  ...
  reason_.UnsafeArenaSetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      reason, GetArena());
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:ControllerReply.reason)
}
...
inline std::string* ControllerReply::unsafe_arena_release_next_token() {
  // @@protoc_insertion_point(field_unsafe_arena_release:ControllerReply.next_token)
  GOOGLE_DCHECK(GetArena() != nullptr);
  _has_bits_[0] &= ~0x00000002u;
  return next_token_.UnsafeArenaRelease(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      GetArena());
}
inline void ControllerReply::unsafe_arena_set_allocated_next_token(
    std::string* next_token) {
  GOOGLE_DCHECK(GetArena() != nullptr);
  if (next_token != nullptr) {
    _has_bits_[0] |= 0x00000002u;
  ...
  next_token_.UnsafeArenaSetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      next_token, GetArena());
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:ControllerReply.next_token)
}
...
inline std::string* Signature::unsafe_arena_release_token() {
  // @@protoc_insertion_point(field_unsafe_arena_release:Signature.token)
  GOOGLE_DCHECK(GetArena() != nullptr);
  _has_bits_[0] &= ~0x00000001u;
  return token_.UnsafeArenaRelease(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      GetArena());
}
inline void Signature::unsafe_arena_set_allocated_token(
    std::string* token) {
  GOOGLE_DCHECK(GetArena() != nullptr);
  if (token != nullptr) {
    _has_bits_[0] |= 0x00000001u;
  ...
  token_.UnsafeArenaSetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      token, GetArena());
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:Signature.token)
}
...
inline std::string* Signature::unsafe_arena_release_pkcs1v15() {
  // @@protoc_insertion_point(field_unsafe_arena_release:Signature.pkcs1v15)
  GOOGLE_DCHECK(GetArena() != nullptr);
  _has_bits_[0] &= ~0x00000002u;
  return pkcs1v15_.UnsafeArenaRelease(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      GetArena());
}
inline void Signature::unsafe_arena_set_allocated_pkcs1v15(
    std::string* pkcs1v15) {
  GOOGLE_DCHECK(GetArena() != nullptr);
  if (pkcs1v15 != nullptr) {
    _has_bits_[0] |= 0x00000002u;
  ...
  pkcs1v15_.UnsafeArenaSetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      pkcs1v15, GetArena());
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:Signature.pkcs1v15)
}
