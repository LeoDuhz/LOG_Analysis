...
inline std::string* TeamRegistration::unsafe_arena_release_team_name() {
  // @@protoc_insertion_point(field_unsafe_arena_release:TeamRegistration.team_name)
...
inline void TeamRegistration::unsafe_arena_set_allocated_team_name(
  ...
  team_name_.UnsafeArenaSetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      team_name, GetArena());
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:TeamRegistration.team_name)
}
...
inline ::GameEvent_BotCrashUnique* AdvantageChoice::release_bot_crash_unique() {
  auto temp = unsafe_arena_release_bot_crash_unique();
  if (GetArena() != nullptr) {
    temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
  }
  return temp;
...
inline ::GameEvent_BotPushedBot* AdvantageChoice::release_bot_pushed_bot() {
  auto temp = unsafe_arena_release_bot_pushed_bot();
  if (GetArena() != nullptr) {
    temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
  }
  return temp;
...
inline ::GameEvent_AttackerTouchedOpponentInDefenseArea* AdvantageChoice::release_attacker_touched_opponent_in_defense_area() {
  auto temp = unsafe_arena_release_attacker_touched_opponent_in_defense_area();
  if (GetArena() != nullptr) {
    temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
  }
  return temp;
