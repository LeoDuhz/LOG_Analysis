...
class AutoRefMessage PROTOBUF_FINAL :
 ...
 public:
  ...
  "    string fields are deprecated and will be removed in a"
  "    future release.")
  std::string* unsafe_arena_release_custom();
  GOOGLE_PROTOBUF_RUNTIME_DEPRECATED("The unsafe_arena_ accessors for"
  "    string fields are deprecated and will be removed in a"
  "    future release.")
...
inline std::string* AutoRefRegistration::unsafe_arena_release_identifier() {
  // @@protoc_insertion_point(field_unsafe_arena_release:AutoRefRegistration.identifier)
...
inline void AutoRefRegistration::unsafe_arena_set_allocated_identifier(
  ...
  identifier_.UnsafeArenaSetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      identifier, GetArena());
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:AutoRefRegistration.identifier)
}
...
inline ::AutoRefMessage* AutoRefToController::release_auto_ref_message() {
  auto temp = unsafe_arena_release_auto_ref_message();
  if (GetArena() != nullptr) {
    temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
  }
  return temp;
...
inline ::BotId* AutoRefMessage_WaitForBots_Violator::release_bot_id() {
  auto temp = unsafe_arena_release_bot_id();
  if (GetArena() != nullptr) {
    temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
  }
  return temp;
...
inline void AutoRefMessage::clear_custom() {
  if (_internal_has_custom()) {
    message_.custom_.Destroy(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
    clear_has_message();
  }
}
...
inline void AutoRefMessage::_internal_set_custom(const std::string& value) {
  ...
  message_.custom_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), value, GetArena());
}
...
inline void AutoRefMessage::set_custom(const char* value) {
  ...
  message_.custom_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
...
inline std::string* AutoRefMessage::_internal_mutable_custom() {
  ...
  return message_.custom_.Mutable(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
inline std::string* AutoRefMessage::release_custom() {
  // @@protoc_insertion_point(field_release:AutoRefMessage.custom)
  if (_internal_has_custom()) {
    clear_has_message();
    return message_.custom_.Release(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
  } else {
    return nullptr;
  }
}
...
inline std::string* AutoRefMessage::unsafe_arena_release_custom() {
  // @@protoc_insertion_point(field_unsafe_arena_release:AutoRefMessage.custom)
  GOOGLE_DCHECK(GetArena() != nullptr);
  if (_internal_has_custom()) {
    clear_has_message();
    return message_.custom_.UnsafeArenaRelease(
        &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
  } else {
    return nullptr;
  }
}
inline void AutoRefMessage::unsafe_arena_set_allocated_custom(std::string* custom) {
  GOOGLE_DCHECK(GetArena() != nullptr);
  if (!_internal_has_custom()) {
    message_.custom_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
  }
  ...
  if (custom) {
    set_has_custom();
    message_.custom_.UnsafeArenaSetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), custom, GetArena());
  }
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:AutoRefMessage.custom)
}
