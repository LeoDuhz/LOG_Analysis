...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_vision_5fdetection_2eproto = {
  false, false, descriptor_table_protodef_vision_5fdetection_2eproto, "vision_detection.proto", 1045,
...
static bool dynamic_init_dummy_vision_5fdetection_2eproto = (static_cast<void>(::PROTOBUF_NAMESPACE_ID::internal::AddDescriptors(&descriptor_table_vision_5fdetection_2eproto)), true);
