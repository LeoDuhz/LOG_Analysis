...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_grSimMessage_2eproto = {
  false, false, descriptor_table_protodef_grSimMessage_2eproto, "grSimMessage.proto", 79,
...
static bool dynamic_init_dummy_grSimMessage_2eproto = (static_cast<void>(::PROTOBUF_NAMESPACE_ID::internal::AddDescriptors(&descriptor_table_grSimMessage_2eproto)), true);
namespace grSimMessage {
