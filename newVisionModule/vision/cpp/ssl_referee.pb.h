...
class ProposedGameEvent PROTOBUF_FINAL :
 ...
 public:
  ...
  "    string fields are deprecated and will be removed in a"
  "    future release.")
  std::string* unsafe_arena_release_proposer_id();
  GOOGLE_PROTOBUF_RUNTIME_DEPRECATED("The unsafe_arena_ accessors for"
  "    string fields are deprecated and will be removed in a"
  "    future release.")
  void unsafe_arena_set_allocated_proposer_id(
...
inline std::string* ProposedGameEvent::unsafe_arena_release_proposer_id() {
  // @@protoc_insertion_point(field_unsafe_arena_release:ProposedGameEvent.proposer_id)
  GOOGLE_DCHECK(GetArena() != nullptr);
  _has_bits_[0] &= ~0x00000001u;
  return proposer_id_.UnsafeArenaRelease(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      GetArena());
}
inline void ProposedGameEvent::unsafe_arena_set_allocated_proposer_id(
    std::string* proposer_id) {
  GOOGLE_DCHECK(GetArena() != nullptr);
  if (proposer_id != nullptr) {
    _has_bits_[0] |= 0x00000001u;
  ...
  proposer_id_.UnsafeArenaSetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      proposer_id, GetArena());
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:ProposedGameEvent.proposer_id)
}
