...
class Log_Frame PROTOBUF_FINAL :
 ...
 public:
  ...
  "    future release.")
  std::string* unsafe_arena_release_refbox_cmd();
  GOOGLE_PROTOBUF_RUNTIME_DEPRECATED("The unsafe_arena_ accessors for"
  "    string fields are deprecated and will be removed in a"
  "    future release.")
  void unsafe_arena_set_allocated_refbox_cmd(
...
inline std::string* Log_Frame::unsafe_arena_release_refbox_cmd() {
  // @@protoc_insertion_point(field_unsafe_arena_release:Log_Frame.refbox_cmd)
  GOOGLE_DCHECK(GetArena() != nullptr);
  _has_bits_[0] &= ~0x00000001u;
  return refbox_cmd_.UnsafeArenaRelease(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      GetArena());
}
inline void Log_Frame::unsafe_arena_set_allocated_refbox_cmd(
    std::string* refbox_cmd) {
  GOOGLE_DCHECK(GetArena() != nullptr);
  if (refbox_cmd != nullptr) {
    _has_bits_[0] |= 0x00000001u;
  ...
  refbox_cmd_.UnsafeArenaSetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      refbox_cmd, GetArena());
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:Log_Frame.refbox_cmd)
}
