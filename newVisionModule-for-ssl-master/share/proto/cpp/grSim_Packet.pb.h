...
::PROTOBUF_NAMESPACE_ID::Metadata descriptor_table_grSim_5fPacket_2eproto_metadata_getter(int index);
class grSim_Packet;
...
class grSim_Packet PROTOBUF_FINAL :
 ...
 public:
  ...
  explicit constexpr grSim_Packet(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    return ::descriptor_table_grSim_5fPacket_2eproto_metadata_getter(kIndexInFileMessages);
  }
