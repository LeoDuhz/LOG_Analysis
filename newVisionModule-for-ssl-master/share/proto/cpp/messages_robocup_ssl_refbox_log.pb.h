...
::PROTOBUF_NAMESPACE_ID::Metadata descriptor_table_messages_5frobocup_5fssl_5frefbox_5flog_2eproto_metadata_getter(int index);
class Log_Frame;
...
class Log_Frame PROTOBUF_FINAL :
 ...
 public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    return ::descriptor_table_messages_5frobocup_5fssl_5frefbox_5flog_2eproto_metadata_getter(kIndexInFileMessages);
  }
...
inline void Log_Frame::_internal_set_refbox_cmd(const std::string& value) {
  _has_bits_[0] |= 0x00000001u;
  refbox_cmd_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArena());
}
...
inline void Log_Frame::set_refbox_cmd(const char* value) {
  ...
  _has_bits_[0] |= 0x00000001u;
  refbox_cmd_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(value), GetArena());
  // @@protoc_insertion_point(field_set_char:Log_Frame.refbox_cmd)
}
inline void Log_Frame::set_refbox_cmd(const char* value,
    size_t size) {
  _has_bits_[0] |= 0x00000001u;
  refbox_cmd_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(
...
inline std::string* Log_Frame::_internal_mutable_refbox_cmd() {
  _has_bits_[0] |= 0x00000001u;
  return refbox_cmd_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArena());
}
