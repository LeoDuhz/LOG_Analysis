...
::PROTOBUF_NAMESPACE_ID::Metadata descriptor_table_zss_5fcmd_2eproto_metadata_getter(int index);
namespace ZSS {
namespace Protocol {
class Robot_Command;
...
class Robots_Status PROTOBUF_FINAL :
 ...
 public:
  ...
  explicit constexpr Robots_Status(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    return ::descriptor_table_zss_5fcmd_2eproto_metadata_getter(kIndexInFileMessages);
  }
...
class Robot_Status PROTOBUF_FINAL :
 ...
 public:
  ...
  explicit constexpr Robot_Status(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
...
class Robots_Command PROTOBUF_FINAL :
 ...
 public:
  ...
  explicit constexpr Robots_Command(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
...
class Robot_Command PROTOBUF_FINAL :
 ...
 public:
  ...
  explicit constexpr Robot_Command(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
