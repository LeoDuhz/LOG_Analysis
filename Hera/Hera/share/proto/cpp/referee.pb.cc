...
void protobuf_AssignDesc_referee_2eproto() {
  ...
  SSL_Referee_Point_reflection_ =
    new ::google::protobuf::internal::GeneratedMessageReflection(
      ...
      GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(SSL_Referee_Point, _unknown_fields_),
      -1,
      ::google::protobuf::DescriptorPool::generated_pool(),
      ::google::protobuf::MessageFactory::generated_factory(),
...
SSL_Referee_Point* SSL_Referee_Point::New() const {
  return new SSL_Referee_Point;
}
...
::google::protobuf::uint8* SSL_Referee_Point::SerializeWithCachedSizesToArray(
    ::google::protobuf::uint8* target) const {
...
void SSL_Referee_Point::MergeFrom(const ::google::protobuf::Message& from) {
  ...
  const SSL_Referee_Point* source =
    ::google::protobuf::internal::dynamic_cast_if_available<const SSL_Referee_Point*>(
      &from);
  if (source == NULL) {
    ::google::protobuf::internal::ReflectionOps::Merge(from, this);
  } else {
...
void SSL_Referee::SerializeWithCachedSizes(
  ...
  if (has_designated_position()) {
    ::google::protobuf::internal::WireFormatLite::WriteMessageMaybeToArray(
      9, this->designated_position(), output);
  }
...
::google::protobuf::uint8* SSL_Referee::SerializeWithCachedSizesToArray(
  ...
  if (has_designated_position()) {
    target = ::google::protobuf::internal::WireFormatLite::
      WriteMessageNoVirtualToArray(
        9, this->designated_position(), target);
  }
...
bool SSL_Referee::IsInitialized() const {
  ...
  if (has_designated_position()) {
    if (!this->designated_position().IsInitialized()) return false;
  }
  if (has_gameevent()) {
    if (!this->gameevent().IsInitialized()) return false;
  }
  return true;
}
