...
class SSL_Referee_Point : public ::google::protobuf::Message {
 public:
  SSL_Referee_Point();
...
class SSL_Referee : public ::google::protobuf::Message {
 public:
  ...
  static const Command BALL_PLACEMENT_YELLOW = SSL_Referee_Command_BALL_PLACEMENT_YELLOW;
  static const Command BALL_PLACEMENT_BLUE = SSL_Referee_Command_BALL_PLACEMENT_BLUE;
  ...
  inline bool has_designated_position() const;
  inline void clear_designated_position();
  static const int kDesignatedPositionFieldNumber = 9;
  inline const ::SSL_Referee_Point& designated_position() const;
  inline ::SSL_Referee_Point* mutable_designated_position();
  inline ::SSL_Referee_Point* release_designated_position();
  inline void set_allocated_designated_position(::SSL_Referee_Point* designated_position);

  // optional bool blueTeamOnPositiveHalf = 10;
  inline bool has_blueteamonpositivehalf() const;
  inline void clear_blueteamonpositivehalf();
  static const int kBlueTeamOnPositiveHalfFieldNumber = 10;
  inline bool blueteamonpositivehalf() const;
  inline void set_blueteamonpositivehalf(bool value);

  // optional .SSL_Referee_Game_Event gameEvent = 11;
  inline bool has_gameevent() const;
  inline void clear_gameevent();
  static const int kGameEventFieldNumber = 11;
  inline const ::SSL_Referee_Game_Event& gameevent() const;
  inline ::SSL_Referee_Game_Event* mutable_gameevent();
  inline ::SSL_Referee_Game_Event* release_gameevent();
  inline void set_allocated_gameevent(::SSL_Referee_Game_Event* gameevent);
...
inline ::SSL_Referee_Point* SSL_Referee::mutable_designated_position() {
  ...
  if (designated_position_ == NULL) designated_position_ = new ::SSL_Referee_Point;
...
inline ::SSL_Referee_Game_Event* SSL_Referee::mutable_gameevent() {
  set_has_gameevent();
  if (gameevent_ == NULL) gameevent_ = new ::SSL_Referee_Game_Event;
