...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_zss_5fkickparam_2eproto = {
  false, false, descriptor_table_protodef_zss_5fkickparam_2eproto, "zss_kickparam.proto", 368,
...
static bool dynamic_init_dummy_zss_5fkickparam_2eproto = (static_cast<void>(::PROTOBUF_NAMESPACE_ID::internal::AddDescriptors(&descriptor_table_zss_5fkickparam_2eproto)), true);
namespace ZSS {
namespace Protocol {
